...
PULSE is an Engineering Intelligence SaaS providing DORA, Lean/Agile, and Sprint analytics. The project has two parallel workstreams: a high-fidelity HTML/CSS/JS prototype (`pulse-ui/`) and a full production stack (`packages/`).
...
- Anything inside `pulse-ui/` (components, pages, layouts, design-system)
...
- Anything inside `packages/` (pulse-api, pulse-data, pulse-web, pulse-shared)
- NestJS modules, FastAPI routes, React+Vite components/routes
- Docker Compose, Dockerfiles, Makefile
...
2. **Scope** — Exact files/directories to create or modify
...
- `docs/frontend-design-doc.md` — Design tokens, component specs, wireframes
- `docs/release-plan.md` — MVP scope, epic/story mapping, BDD criteria
- `docs/product-spec.md` — Feature descriptions, personas, pricing
- `docs/architecture.md` — Tech decisions, DB schema, API contracts
- `docs/architecture-analysis.md` — Data architecture decision (DevLake hybrid)
- `docs/market-research.md` — Competitive landscape, positioning
